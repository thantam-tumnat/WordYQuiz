...
เกมทดสอบ **คำศัพท์** (vocabulary quiz) — ที่ได้แรงบันดาลใจแอป Toeic Zombie ซึ่งทำให้ผมมีไอเดียว่าถ้าเปลี่ยนจากคำศัพท์ toeic เป็น oxford 3000 คงจะสนุกและท้าทายขึ้น
...
สไตล์เดียวกับ kahoot แต่ถ้าคุณเป็นผู้เล่นละดับ C2 ที่ไม่ได้อยากแข่งกับความเร็วคุณสามารถตอบได้เรื่อยๆ เพื่อให้ได้คะแนนและเป็นตัวท็อปเซิฟ
